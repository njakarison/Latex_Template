...
\documentclass[
    ...
    memoireLicence, %%% Type de rapport à produire : memoireMaitrise, projetTutore, memoireLicence, ....
...
\input{couverture/1-titre}
%% Liste des encadreurs
\input{couverture/2-encadreurs}
%% Liste des jurys 
\input{couverture/3-jurys}
...
%%%- Avant propos -%%
\input{parties/01-avantpropos}

%%- Remerciements -%%
\input{parties/02-remerciements}

%%- Sommaire  et abstract-%%
\input{parties/03-resume}
...
\input{parties/04-abbreviations}

%%- Déclaration et affichage de la liste des symboles -%%
\input{parties/05-symboles}
...
%% Introduction
\input{parties/06-introduction}

%%- Premier chapitre de démonstration -%%
\input{parties/chapitre1}

%%- Deuxiemme chapitre de démonstration -%%
\input{parties/chapitre2}

%%- chapitre 3 -%%
\input{parties/chapitre3}
