...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% memoireMaitrise; projetTutore; projetSemestre; memoireLicence; projet; miniProjet

\documentclass[a4paper, oneside, 12pt, memoireMaitrise, francais, creativecommons, hyperref]{memoESPA}
...
\input{include/1-rapport}
%% Liste des encadreurs
\input{include/2-encadreurs}
%% Liste des jurys 
\input{include/3-jurys}
...
\lipsum[1-3] % Texte de remplissage pour donner un exemple de la mise en page
...
\subsection{figures}
    ...
    \begin{figure}
    	\centering % Les figures doivent être centrées
    		\includegraphics[width=0.9\textwidth]{figures/logoESPA.png} % Spécification du paramètres "width", la largeur de l'image (en conservant les proportions). La largeur est ici restreinte à 0.75 fois "\textwidth", qui est la largeur maximale du texte dans le document en prenant en compte les marges
...
\begin{spacing}{1}
	...
	\bibliographystyle{unsrt} % Utilisation du style bibliographique de l'ETS
